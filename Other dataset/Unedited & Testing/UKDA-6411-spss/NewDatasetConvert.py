...
age7 = pd.read_spss('mcs4_cm_interview - test.sav')
age17 =pd.read_spss('mcs7_cm_interview - test.sav')




age7.drop(age7.columns.difference(featuresList),1,inplace=True)
age7.rename(columns=featuresMap,inplace=True)

age17.drop(age17.columns.difference(featuresList),1,inplace=True)
